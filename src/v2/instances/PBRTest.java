...
//
//public class PBRTest extends SceneContext {
//
//    Node object;
//
...
//            if(InputManager.instance().isKeyHeld(GLFW_KEY_LEFT_CONTROL)){
...
//
//        if(InputManager.instance().isKeyHeld(GLFW_KEY_Q)) {
//            deg-=0.05;
//        }
//        if(InputManager.instance().isKeyHeld(GLFW_KEY_E)){
//            deg += 0.05;
//        }
//
//        camera.rotateAround(camera.getForward(), deg);
//
//        if(InputManager.instance().isKeyHeld(GLFW_KEY_R)) {
//            if(InputManager.instance().isKeyHeld(GLFW_KEY_LEFT_CONTROL)){
...
//        }
//
//        if(InputManager.instance().isKeyPressed(GLFW_KEY_RIGHT_BRACKET)){
//            light.setIntensity(light.getIntensity()+1);
//        }
//        if(InputManager.instance().isKeyPressed(GLFW_KEY_LEFT_BRACKET)){
//            light.setIntensity(light.getIntensity()-1);
//        }
//
//    }
...
////                model = new PBRModel(new VertexBufferObject(MeshData.loadMesh("res/models/application.obj")),
