...
public class StaticLoader {
    ...
    public static ArrayList<Mesh3D> loadMeshGroup(String filename){
        ...
        AIScene scene = Assimp.aiImportFile(StaticLoader.absolutePath(filename),
                0);
    ...
    public static String absolutePath(String relativePath){
        return StaticLoader.class.getClassLoader().getResource(relativePath).getPath().substring(1)
